...
final class CreateArticleTags extends AbstractMigration
{
    public function change(): void
    {
        ...
        $articleTags
            ->addColumn('article_translate_id', MysqlAdapter::PHINX_TYPE_INTEGER, ['signed' => false, 'null' => false])
            ->addColumn('tag_id', MysqlAdapter::PHINX_TYPE_INTEGER, ['signed' => false, 'null' => false])
